...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "lai-upload-component" },
        React.createElement("div", { className: "lai-upload-input", style: { display: 'inline-block' }, onClick: handleClick },
            drag ? React.createElement(Dragger, { onFile: function (files) { uploadFiles(files); } }, children) : children,
            React.createElement("input", { ref: fileInput, type: "file", className: "lai-file-input", style: { display: 'none' }, onChange: handleFileChange, accept: accept, multiple: multiple }),
